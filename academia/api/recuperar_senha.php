...
$pdo->exec("CREATE TABLE IF NOT EXISTS reset_tokens (id INT AUTO_INCREMENT PRIMARY KEY, usuario_id INT, token VARCHAR(64), expira DATETIME, usado TINYINT DEFAULT 0)");
...
$headers = "From: noreply@ironboxbarbearia.com.br\r\nContent-Type: text/plain; charset=UTF-8";
