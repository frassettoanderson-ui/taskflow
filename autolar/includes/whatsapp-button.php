<?php /* Botão flutuante de WhatsApp (presente em todas as páginas) */ ?>
<a class="wa-float" href="<?= e(whatsapp_link()) ?>" target="_blank" rel="noopener" aria-label="Falar no WhatsApp">
