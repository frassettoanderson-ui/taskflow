...
import motivoCancelamentoRoutes from './modules/empresa/motivoCancelamento.routes.js';
import grupoEmpresaRoutes from './modules/empresa/grupoEmpresa.routes.js';
...
api.use('/motivos-cancelamento', motivoCancelamentoRoutes);
api.use('/grupos-empresa', grupoEmpresaRoutes);
